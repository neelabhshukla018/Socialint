                      ...
                      >
                        ...
                        >
                          <span className="relative flex flex-col items-center">
                            ...
                            <span className="mt-0.5 text-[11px] font-extrabold text-zinc-900 dark:text-zinc-100">
                              {node.influence}
                            </span>
                          </span>
                        </span>
                        ...
                        <span className="absolute left-1/2 top-full mt-2 w-max -translate-x-1/2 pointer-events-none">
                          <span
                            className={`block text-xs font-bold text-center ${
                              isSelected ? "text-[#457B9D]" : "text-zinc-800 dark:text-zinc-200"
                            }`}
                          >
                            {node.name}
                          </span>
                          <span className="block text-[10px] text-zinc-400 dark:text-zinc-500 text-center">
                            {node.type}
                          </span>
                        </span>
                      </button>
                  ...
                  <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
                    ...
                    <div className="flex items-center gap-6">
                      ...
                      <button
                        ...
                        className="rounded-xl border border-zinc-200 dark:border-zinc-700 p-2 text-zinc-500 dark:text-zinc-400 hover:bg-zinc-100 dark:hover:bg-zinc-800 hover:text-zinc-900 dark:hover:text-zinc-100 transition"
  ...
  return (
    <div className="rounded-2xl border border-zinc-200/80 dark:border-zinc-800/80 bg-white dark:bg-zinc-900/60 p-5 shadow-xs transition duration-200 hover:border-zinc-300 dark:hover:border-zinc-700 hover:shadow-md">
      <div className="flex items-start justify-between">
        ...
        {positive && (
          <span className="rounded-full border border-emerald-200 dark:border-emerald-900/50 bg-emerald-50 dark:bg-emerald-950/40 px-2 py-0.5 text-xs font-semibold text-emerald-700 dark:text-emerald-400">
            Live
          </span>
        )}
      </div>
