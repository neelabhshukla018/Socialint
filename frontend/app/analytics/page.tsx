            ...
            <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
              ...
              <div className="flex items-center gap-3">
                ...
                <select
                  ...
                  className="rounded-xl border border-zinc-200 bg-white px-4 py-2 text-sm font-medium text-zinc-800 shadow-xs outline-none transition focus:border-[#457B9D]"
                >
                ...
                <div className="mt-6 h-[280px] w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={platformData}>
                      ...
                      />
                      <Tooltip
                        cursor={{ fill: "rgba(69, 123, 157, 0.06)" }}
                        contentStyle={{
                          backgroundColor: "#ffffff",
                          border: "1px solid #e4e4e7",
                          borderRadius: "12px",
...
function Insight({
  ...
  return (
    <div className="rounded-2xl border border-zinc-200/80 bg-zinc-50/50 p-4 transition hover:bg-zinc-50">
