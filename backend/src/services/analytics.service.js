...
export async function getAnalytics(profileId) {
    ...
    const positivePercentage = totalPosts > 0
        ? Number(((positivePosts / totalPosts) * 100).toFixed(2))
        : 0;
    const negativePercentage = totalPosts > 0
        ? Number(((negativePosts / totalPosts) * 100).toFixed(2))
        : 0;
    const neutralPercentage = totalPosts > 0
        ? Number(((neutralPosts / totalPosts) * 100).toFixed(2))
        : 0;
    /* =========================================================
       TOP POSTS
       ========================================================= */
    const topPosts = [...posts]
        .sort((a, b) => {
        const engagementA = a.likes +
            a.comments +
            a.shares;
        const engagementB = b.likes +
            b.comments +
            b.shares;
    ...
    /* =========================================================
       AUDIENCE
       ========================================================= */
    const audienceInsights = audience.map((insight) => ({
        id: insight.id,
