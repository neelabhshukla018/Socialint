...
/* =========================================================
   DATABASE FALLBACK
   ========================================================= */
async function findPostInDatabase(url) {
...
async function fetchPublicPage(url) {
    ...
    if (!html.trim()) {
        throw new Error("Platform returned an empty page.");
    }
    return html;
}
/* =========================================================
   ...
   ========================================================= */
export async function collectPostFromUrl(url) {
    ...
    /* =======================================================
       ...
       ======================================================= */
    const existing = await findPostInDatabase(url);
    if (existing) {
        return {
            platform,
            url,
    ...
    try {
        ...
        console.error(`Failed to fetch ${platform} URL:`, error);
        throw new Error(`${platform} post could not be retrieved. The platform may require authentication or block public access.`);
    }
    /* =======================================================
       OPEN GRAPH DATA
       ======================================================= */
