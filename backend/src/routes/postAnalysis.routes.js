...
import { getPostAnalysisController, analyzePostController, proxyImageController, } from "../controllers/postAnalysis.controller.js";
const router = Router();
/**
 ...
 * }
 */
router.post("/analyze", analyzePostController);
