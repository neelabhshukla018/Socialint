...
import { createReportController, getReportsController, getReportController, updateReportController, deleteReportController, } from "../controllers/report.controller.js";
const router = Router();
/* =========================================================
   REPORTS
   ========================================================= */
