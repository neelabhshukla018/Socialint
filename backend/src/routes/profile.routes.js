...
import { createProfileController, getProfilesController, getProfileController, updateProfileController, activateProfileController, deleteProfileController, } from "../controllers/profile.controller.js";
const router = Router();
// Create profile
