...
import { getDataSourcesController, getDataSourceController, connectDataSourceController, updateDataSourceController, disconnectDataSourceController, deleteDataSourceController, } from "../controllers/dataSource.controller.js";
const router = Router();
...
// Disconnect source
router.patch("/:id/disconnect", disconnectDataSourceController);
